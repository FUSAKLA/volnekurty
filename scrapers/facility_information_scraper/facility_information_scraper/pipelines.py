from facility_information_scraper.db_driver.mongo import MongoDriver
from facility_information_scraper.lib.facility import Facility


class FacilityInformationScraperPipeline(object):
    @staticmethod
